...
export const envTypes = {
  runtime_memory_allocator_maybeGrowMemory: '(i32) void',
  runtime_common_BLOCK_set_mmInfo: '(i32 i32) void',
  runtime_memory_allocator___alloc: '(i32) i32',
  runtime_common_BLOCK_get_mmInfo: '(i32) i32',
  runtime_memory_allocator___realloc: '(i32 i32) i32',
  runtime_memory_allocator___free: '(i32) void',
  runtime_memory_allocator___reset: '() void',
  runtime_common_OBJECT_set_gcInfo: '(i32 i32) void',
  runtime_common_OBJECT_set_gcInfo2: '(i32 i32) void',
  runtime_common_OBJECT_set_rtId: '(i32 i32) void',
  runtime_common_OBJECT_set_rtSize: '(i32 i32) void',
  runtime_memory_allocator___new: '(i32 i32) i32',
  runtime_memory_allocator___renew: '(i32 i32) i32',
  runtime_memory_allocator___link: '(i32 i32 i32) void',
  runtime_memory_allocator___pin: '(i32) i32',
  runtime_memory_allocator___unpin: '(i32) void',
  runtime_memory_allocator___collect: '() void',
