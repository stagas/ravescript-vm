...
const ld0: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.004771345))
const ld1: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.003595309))
const ld2: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.012734787))
const ld3: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.009307483))
const ld4: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.022579886))
const ld5: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.149625349))
const ld6: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.060481839))
const ld7: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.1249958))
const ld8: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.030509727))
const ld9: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.141695508))
const ld10: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.089244313))
const ld11: u32 = nearestPowerOfTwo(<u32>(44100.0 * 0.106280031))
...
const lo0: u32 = u32(0.008937872 * 44100)
const lo1: u32 = u32(0.099929438 * 44100)
const lo2: u32 = u32(0.064278754 * 44100)
const lo3: u32 = u32(0.067067639 * 44100)
const lo4: u32 = u32(0.066866033 * 44100)
const lo5: u32 = u32(0.006283391 * 44100)
const lo6: u32 = u32(0.035818689 * 44100)

const ro0: u32 = u32(0.011861161 * 44100)
const ro1: u32 = u32(0.121870905 * 44100)
const ro2: u32 = u32(0.041262054 * 44100)
const ro3: u32 = u32(0.08981553 * 44100)
const ro4: u32 = u32(0.070931756 * 44100)
const ro5: u32 = u32(0.011256342 * 44100)
const ro6: u32 = u32(0.004065724 * 44100)
...
export class Daverb extends Gen {
  ...
  _audio(begin: u32, end: u32, out: usize): void {
    ...
    let exc_phase: u32 = this._excPhase
    let exc: f32 = 0
    // let exc2: f32 = 0
    ...
    for (; i < end; i += 16) {
      unroll(16, () => {
        ...
        // exc2 = this.edn * (1.0 + Mathf.sin(exc_phase * 6.2847))
