...
// @ts-ignore: decorator
@lazy export let offset: usize = startOffset
...
export function __alloc(size: usize): usize {
  if (size > BLOCK_MAXSIZE) throw new Error("Not enough memory to allocate.")
...
export function __new(size: usize, id: u32): usize {
  if (size > OBJECT_MAXSIZE) throw new Error("Not enough memory to allocate.")
